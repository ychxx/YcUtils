...
public class BannerView extends RelativeLayout {
    ...
    BannerAdapter.ViewPagerOnItemClickListener mItemClickListener;//点击回调事件
     ...
     */
    public BannerView setOnItemClickListener(BannerAdapter.ViewPagerOnItemClickListener viewPagerOnItemClickListener) {
