...
public class YcStatusBar {
    ...
    private YcStatusBar(Window window, boolean lightStatusBar, boolean transparentStatusBar, boolean transparentNavigationbar, View actionBarView) {
    ...
    public final static class Builder {
        ...
        public void process() {
            new YcStatusBar(window, lightStatusBar, transparentStatusbar, transparentNavigationbar, actionBarView).process();
        }
    }
}
