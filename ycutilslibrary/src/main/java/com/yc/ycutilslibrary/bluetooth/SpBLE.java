...
public class SpBLE {
    ...
    private final static String ACTION_GATT_DISCONNECTING = "com.usr.bluetooth.le.ACTION_GATT_DISCONNECTING";
    ...
    private BluetoothGattCallback callback = new BluetoothGattCallback() {
        ...
        public void onCharacteristicChanged(BluetoothGatt gatt, BluetoothGattCharacteristic characteristic) {
            ...
            mHandler.obtainMessage(MainActivity.MESSAGE_READ, data.length, -1, data)
                    .sendToTarget();
        }
    ...
    public void Write(byte[] data) {
        ...
        if (gatt.writeCharacteristic(tx)) {
            mHandler.obtainMessage(MainActivity.MESSAGE_WRITE, data.length, -1, data)
                    .sendToTarget();
            writeLine("Sent: ");
        } else {
